class HotkeyManager:
    ...
    def add_hotkey(self, key, func, weapon_name, pistol_name, shield_name):
        if weapon_name or pistol_name or shield_name:
            if not key == "b" and not key == "esc" and not key is None:
                self.hotkeys[key] = {"func": func, "weaponName": weapon_name,
                                     "pistolName": pistol_name, "shieldName": shield_name}
