...
class ShoppingCart:
    ...
    def __init__(self, collection_weapons, collection_pistols):
        self.weapons = collection_weapons
        self.pistols = collection_pistols
    ...
    def get_pistol(self, name):
        for pistol in self.pistols:
            if pistol.name == name:
                return pistol


weapons = [stinger, spectre, bucky, judge, bulldog, guardian,
           phantom, vandal, marshal, operator, ares, oding]
